            ...
            <div className='new-article-modal-container'>
                ...
                <div className='new-article-form'>
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <input type='text' className='form-input' name='date' placeholder='MM-DD-YYYY' autoComplete='off'  {...register('date', {required: true})}/> 
                        ...
                        <input type='text' className='form-input new-article-form-body-input' name='body1' placeholder='Share some thoughts, friend...' autoComplete='off'  {...register('body1', {required: true})}/> 
                        ...
                        <input type='text' className='form-input new-article-form-body-input' name='body2' autoComplete='off'  {...register('body2')}/> 
                        ...
                        <input type='text' className='form-input new-article-form-body-input' name='body3' autoComplete='off'  {...register('body3')}/> 
                        ...
                        <input type='text' className='form-input new-article-form-body-input' name='body4' autoComplete='off'  {...register('body4')}/> 
                        ...
                        <input type='text' className='form-input new-article-form-body-input' name='body5' autoComplete='off'  {...register('body5')}/> 
                        ...
                        <input type='text' className='form-input new-article-form-body-input' name='body6' autoComplete='off'  {...register('body6')}/> 
                        ...
                        <input type='text' className='form-input new-article-form-body-input' name='body7' autoComplete='off'  {...register('body7')}/> 
                        ...
                        <input type='text' className='form-input new-article-form-body-input' name='body8' autoComplete='off'  {...register('body8')}/> 
                        ...
                        <input type='text' className='form-input new-article-form-body-input' name='body9' autoComplete='off'  {...register('body9')}/> 
                        ...
                        <input type='text' className='form-input new-article-form-body-input' name='body10' autoComplete='off'  {...register('body10')}/> 
